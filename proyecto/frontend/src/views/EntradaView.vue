    ...
    <section class="vh-100">
        <div class="container py-5 h-100">
            ...
            <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                ...
                <form>
                <h3 class="mb-5"> Entrada de Usuarios</h3>
                ...
                <!-- Submit button -->
                <button @click.prevent="registro()" type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg btn-block">
                    Validate
                </button>
                <p></p>
                <button @click.prevent="registroGoogle()" type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-dark btn-lg btn-block">
                    <Icon icon="logos:google-icon"/> Inicia sesion con Google 
                </button>
...
import { provide } from "vue";
    export default {
        ...
        methods:{
            registro(){
                signInWithEmailAndPassword(getAuth(), this.correo, this.password).then((data) => {
                    this.mensaje = ''
                    this.correo = ''
                    this.password = ''
                }).catch((error) => {
                    switch (error.code) {
                        ...
                        default:
                            this.mensaje = "Correo o contrasenia incorrecta"
                            break;
                    }
                })
            },
